...
class BottleNumberScreenOriginal extends StatelessWidget {
  const BottleNumberScreenOriginal({super.key});
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Stack(
          children: [
            Align(
              alignment: Alignment(1.0, - 0.48),
              child: SizedBox(
                width: ThemeConstants.screenWidth * 8 / 100,
                height: ThemeConstants.screenHeight * 63 / 100,
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Icon(CupertinoIcons.add, weight: 30, size: ThemeConstants.screenHeight * 3 / 100,),
                    WheelSlider(
                      horizontal: false,
                      isInfinite: true,
                    ...
                    Icon(CupertinoIcons.minus, weight: 30, size: ThemeConstants.screenHeight * 3 / 100,),
                  ],
                ),
              ),
            ),
